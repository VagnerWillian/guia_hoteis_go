      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ListTile(
                    ...
                    leading: const SvgIcon(SvgIconData.goAfter, size: 25, color: Colors.white),
                    title: FittedBox(
                      child: Text(
                        'go fidelidade',
            ...
            _buildMenuItem(icon: SvgIconData.myReservations, name: 'minhas reservas'),
            ...
            _buildMenuItem(icon: SvgIconData.megafone, name: 'tem um motel? faça parte'),
          ],
        ),
      ),
    );
